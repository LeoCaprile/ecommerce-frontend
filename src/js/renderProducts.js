...
export const loader =
	'<div class="grid col-span-full row-span-6 rounded-full border-8 border-l-transparent border-blue-500 w-20 h-20 transition-all animate-spin duration-200 ease-linear"></div>';

export const productNotFoundMsg = `<div class="text-center w-50 pt-20 md:pt-0 h-fit md:h-20 md:col-span-4 md:row-end-3 "><i class="mb-5 fas fa-search fa-7x"></i><i class="relative -z-10 right-20 bottom-8 fas fa-question fa-3x"></i>
